...
| **LLaDA, [2502.09992](https://arxiv.org/abs/2502.09992)** | The masked-diffusion (MDM) training objective, EOS/padding handling, and block-wise generation. | the shared `dllm` package (our small-model implementation) |
...
```
(dllm package)         discrete-diffusion LM core + block-wise sampler - external
                       dependency: https://github.com/Tieumi221E/dllm
src/
